...
import com.rahul.bean.EmployeeBean;
...
public class EmployeeController {
	...
	public ModelAndView listEmployees() {
		System.out.println("Inside the EmployeeController class...........");
		Map<String, Object> model = new HashMap<String, Object>();
		model.put("employees",  prepareListofBean(employeeService.listEmployeess()));
		System.out.println("Inside the EmployeeController class.......Here is the list of employees...." +employeeService.listEmployeess().size());
